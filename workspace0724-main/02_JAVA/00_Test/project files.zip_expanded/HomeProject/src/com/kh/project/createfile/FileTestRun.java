package com.kh.project.createfile;
...
public class FileTestRun {
	...
	public static void main(String[] args) {
		//Properties
		//Properties 클래스는 Map 계열의 컬렉션으로, Key-value 형식으로 데이터를 저장/읽기할 수 있음
		//특히 외부파일(.Properties / .xml)을 통해 데이터를 쉽게 관리하고 불러올 수 잇음.
		//DB연결정보, 프로그램 설정정보(port, 환경변수...), sql쿼리문 코드와 분리해서 관리할 때 주로 사용.
		...
		try {
			...
			//.properties파일 -> 단순 텍스트 파일(key-value 형식)
