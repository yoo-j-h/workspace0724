...
public class Variable {
	 ...
	 *자료형 변수이름;
	 *
	 *자료형 : 변수가 사용할 메모리크기에 따라 지정
	 *변수이름 : 변수를 식별하기 위해 붙이는 이름
	 * 
	 * */
	public static void main(String[] args) {
		...
		//참과 거짓을 표현하는 자료형으로 isTrue라는 이름의 변수를 선어
		boolean isTrue = false;//선언과 동시에 false값 대입
		System.out.println(isTrue);
		
		
		//실수형(소수정 6자리까지 사용) 자료형으로 num2라는 이름의 변수를 선언
		float num2;
		num2 = 3.141592f;
		System.out.printf("%.4f",num2);
		 ...
		 * 모두 정수를 지정하는 자료형, 각 자료형마다 저장할 수 있는 수의 범위가 다름.
		 * 
		 * 정수 리터널의 기본값은 int
		 ...
		 * 실수 자료형
		 * float(4) double(8)
		 * 실수를 저장하는 자료형, float보다 double이 더 정밀하게 표현 가능
		 * 
		**/
		float fl = 4.24f;
		double dou = 4.24;
		...
		char ch1 = '최'; //2바이트 유니코드 정수로 저장
		char ch2 = '지';
		char ch3 = '원';
		System.out.println("" + ch1+ ch2+ ch3);//기본적으로 char은 연산시 int로 형변환
		...
		// \\ : 백슬래시(\)
		//문자 자체로 출력
		System.out.println("경로 : C:\\workspace\\02_JAVA\\00_TEST");
		...
		/*
		 * 프로그래밍에서 이름 짓는 방식
		 * 카멜케이스 : 단어를 나열하며 이름을 짓되, 두번째 단어부터는 단어의 첫글자를 대문자로 시작(자바에서 모든 메서드, 변수명)
		 ...
		 * ex) USER_NAME, TOTAL_PRICE
		 * 케밥케이스 : 단어를 소문자롤 작성하되 문자와 문자사이를 하이픈(-)으로 이어주는 것(html속성, url, 설정파일등)
