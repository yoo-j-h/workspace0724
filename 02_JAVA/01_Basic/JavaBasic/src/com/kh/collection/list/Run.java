...
public class Run {
	...
	public static void main(String[] args) {
		...
		System.out.println(list); //빈배열 상태
		...
		//4. remove(E e) : 객체를 직접 지정해서 삭제(사용을 위해서는 객체의 equals를 적절히 오버라이딩해줘야함)
		...
		//검색 search(E e) 데이터 검색 후 존재하면 위치반환(위에서부터 센다) -> eaquals를 사용하여 비교
