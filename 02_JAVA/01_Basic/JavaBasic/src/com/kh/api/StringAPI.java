...
public class StringAPI {
	public void method01() {
		...
		//+String클해스에 yoString메서드는 이미 오버라이딩 되어있음
		//Object의 toString(형식)이 아니라 String의 저장된 문자열이 반환
		
		System.out.println(str1==str2);
		//String객체의 주소값을 비교하기 때문에 false가 나옴
		
		System.out.println(str1.equals(str2));
		//String 클래스에서 equals메서드도 이미 오버라이딩 되어있음(주소값 비교가 아니라 문자열 값을 비교하도록)
		...
		//문자열 리터널 사용시 상수풀영역에 문자열을 생성
		//String pool : 동일한 문자열을 중복해서 가지지않는다.
		...
		str3 = "bye";
		System.out.println(System.identityHashCode(str3));
		//String 리터럴의 특성상 참조변수에 값을 변경하도록 순간 기존의 문자열 메모리에 값을 변경하는게 아니라
	...
	public void method03() {
		...
		System.out.println(stn.countTokens());//토큰에 남은 개수
		...
		for(int i=0; i<size; i++) {
			System.err.println(stn.nextToken());
		}
