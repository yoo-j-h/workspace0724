...
public class MemberMenu {
	...
	private void bulkDeleteMembers() {
		System.out.println("========= 다중 회원 탈퇴 ===========");
	...
	//회원추가를 몇명할것인지?
	private void bulkInsertMembers() {
		System.out.println("========= 다중 회원 추가 ===========");
		System.out.print("추가할 회원의 숫자 : ");
		int count = sc.nextInt();
		sc.nextLine();
		ArrayList<Member> list = new ArrayList<Member>();
		for(int i=1; i<=count; i++) {
			System.out.printf("========= 회원 추가(%d) ===========\n",i);
