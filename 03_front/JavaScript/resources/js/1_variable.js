...
//.log() console 객체의 메서드중 하나로 메세지를 출력 -> 개발자도구에 console영역에 표시됨.
 ...
 * 2) 특수문자는 언더스코어(_) 달러($)를 사용할 수 있음.
 * 3) 숫자로 시작하면 안된,
 * 4) 키워들르 변수명으로 사용하면 안됨.
 * 
 ...
 * 다만 js에서는 개발자가 직접 명시적으로 값을 초기화 할때 사용
 */
let init = 10;
init = null;
console.log(init);
...
console.log("symbal1 === symbol2 : " , symbol1 === symbol2);

/**
 * Object -> 프로타입체인의 최상위 object가 Object
 * object타입
 * 
 * 키 : 벨류
 * key : value -> map의 구조
